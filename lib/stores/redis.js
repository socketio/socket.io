...
Client.prototype.get = function (key, fn) {
  this.store.cmd.hget(this.store.prefix + this.id, key, fn);
  return this;
};
...
Client.prototype.set = function (key, value, fn) {
  this.store.cmd.hset(this.store.prefix + this.id, key, value, fn);
  return this;
};
...
Client.prototype.del = function (key, fn) {
  this.store.cmd.hdel(this.store.prefix + this.id, key, fn);
  return this;
};
...
Client.prototype.has = function (key, fn) {
  this.store.cmd.hexists(this.store.prefix + this.id, key, function (err, has) {
...
Client.prototype.destroy = function (expiration) {
  if ('number' != typeof expiration) {
    this.store.cmd.del(this.store.prefix + this.id);
  } else {
    this.store.cmd.expire(this.store.prefix + this.id, expiration);
  }
