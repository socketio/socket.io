...
function Redis (opts) {
  ...
  // initialize pub/sub clients and a regular client
...
/**
 * Redis hash key exists
 *
 * @api private
 */

Client.prototype.has = function (key, fn) {
  this.store.client.hexists(this.id, key, fn);
  return this;
};
...
Client.prototype.set = function (key, value, fn) {
  this.store.client.hset(this.id, key, value, fn);
  return this;
};
...
Client.prototype.del = function (key, fn) {
  this.store.client.hdel(this.id, key, fn);
  return this;
};
