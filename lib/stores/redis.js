...
function Redis (opts) {
  ...
  if (opts.redisPub instanceof RedisClient) {
    ...
    opts.redisPub || (opts.redisPub = (opts.redisClient && !(opts.redisClient instanceof RedisClient)) ? opts.redisClient : {});
  ...
  if (opts.redisSub instanceof RedisClient) {
    ...
    opts.redisSub || (opts.redisSub = (opts.redisClient && !(opts.redisClient instanceof RedisClient)) ? opts.redisClient : {});
