...
Client.prototype.send = function(message){
  if (this.buffered || !this._open || !(this.connection.readyState === 'open' || this.connection.readyState === 'writeOnly')){
...
Client.prototype.buffer_sends = function(callback, context){
  this.buffered = true;
  try {
