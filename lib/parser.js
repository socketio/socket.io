...
exports.encodePacket = function encodePacket (packet) {
...
exports.encodePayload = function encodePayload (packets) {
  var decoded = '';
...
exports.decodePacket = function decodePacket (data) {
...
exports.decodePayload = function decodePayload (data) {
  if (data[0] == '\ufffd') {
    var ret = [];
