...
Parser.prototype.add = function(data) {
  // an alternative and probably cleaner approach would be:
  // remove all occurrences of this._dataLength 
  // 
  // then use these two lines instead of the following two lines
  // var toRead = Math.min(data.length, this.expectBuffer? this.expectBuffer.length - this.expectOffset : 0);
  // if (toRead + this.expectOffset > this._maxBuffer) {
