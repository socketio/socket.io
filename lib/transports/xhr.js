...
(function(){
  ...
  /**
   * This is the base for XHR transports, the `XHR-Polling` and the `XHR-multipart` transports will extend
   * this class.
   *
   * @constructor
   ...
   *
   * @param {Boolean} xdomain Check if we support crossdomain requests.
   * @returns {Boolean}
   * @api public
   */
  ...
  /**
   * Check if the XHR transport supports corssdomain requests.
   * 
   * @returns {Boolean}
   * @api public
   */
