...
HTTPPolling.prototype.setHeartbeatTimeout = function setHeartbeatTimeout () {
  return;
};
...
HTTPPolling.prototype.clearHeartbeatTimeout = function clearHeartbeatTimeout () {
  return;
};
...
HTTPPolling.prototype.onData = function onData (data) {
