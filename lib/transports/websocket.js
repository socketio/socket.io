...
WebSocket.prototype.isSecure = function () {
  return this.socket.encrypted || (this.req.headers.origin && this.req.headers.origin.substring(0, 6) === 'https:');
};
