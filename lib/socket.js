...
Socket.prototype.packet = function (packet) {
  if (this.flags.broadcast) {
    ...
    if (this.flags.volatile) { this.store.publish('volatile:' + this.id, packet); }
    else { this.store.client(this.id).publish(packet); }
  }
...
Socket.prototype.emit = function (ev) {
  if (events[ev]) { return this.$emit.apply(this, arguments); }
