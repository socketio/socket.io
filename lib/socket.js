...
/**
 * Set up socket packet middleware
 *
 * @param fn
 * @returns {Socket}
 * @api public
...
/**
 * Executes the middleware for an incoming packet.
 *
 * @param {Object} packet that will get through
...
Socket.prototype.onevent = function(packet){
  var self = this;
  debug('pass packet to mounted middlewares');
