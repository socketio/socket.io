...
(function(){
   ...
   *
   * Options:
   *   - `timeout`  Transport shutdown timeout in miliseconds, based on the heartbeat interval.
   *
   * @constructor
   * @exports Transport as io.Transport
   * @property {io.Socket|Object} base The reference to io.Socket.
   * @property {Object} options The transport options.
   * @param {io.Socket|Object} base The reference to io.Socket.
   ...
   *
   * @throws {Error} If not overwitten.
   * @api public
   */
