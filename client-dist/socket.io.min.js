...
! function (t, e) {
    ...
    for (var k = {
            ...
            var r, i = t.type,
                o = t.data;
            return w && o instanceof Blob ? e ? n(o) : A(o, n) : _ && (o instanceof ArrayBuffer || (r = o, "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer)) ? e ? n(o) : A(new Blob([o]), n) : n(m[i] + (o || ""))
        }, A = function (t, e) {
    ...
    var At = function () {
            ...
            return r(t, [{
                key: "encode",
                value: function (t) {
                    return t.type !== Ot.EVENT && t.type !== Ot.ACK || !mt(t) ? [this.encodeAsString(t)] : (t.type = t.type === Ot.EVENT ? Ot.BINARY_EVENT : Ot.BINARY_ACK, this.encodeAsBinary(t))
                }
            }, {
                key: "encodeAsString",
                value: function (t) {
