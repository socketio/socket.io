...
From the [6.5.x](https://github.com/socketio/engine.io-client/tree/6.5.x) branch:

| Version                  | Release date | `ws` version | Bundle size (UMD min+gzip) |
|--------------------------|--------------|--------------|----------------------------|
| [6.5.4](#654-2024-06-18) | June 2024    | `~8.17.1`    | `8.8 KB`                   |

From the [3.5.x](https://github.com/socketio/engine.io-client/tree/3.5.x) branch:

| Version                  | Release date   | `ws` version | Bundle size (UMD min+gzip) |
|--------------------------|----------------|--------------|----------------------------|
| [3.5.4](#354-2024-06-18) | June 2024      | `~7.5.10`    | `-`                        |
| [3.5.3](#353-2022-09-07) | September 2022 | `~7.4.2`     | `-`                        |
| [3.5.2](#352-2021-05-05) | May 2021       | `"`          | `-`                        |
| [3.5.1](#351-2021-03-02) | March 2021     | `~6.1.0`     | `-`                        |

From the [6.0.x](https://github.com/socketio/engine.io-client/tree/6.0.x) branch:

| Version                  | Release date  | `ws` version | Bundle size (UMD min+gzip) |
|--------------------------|---------------|--------------|----------------------------|
| [6.0.3](#603-2021-11-14) | November 2021 | `"`          | `7.4 KB`                   |


From the [4.1.x](https://github.com/socketio/engine.io-client/tree/4.1.x) branch:
...
## [6.6.6](https://github.com/socketio/socket.io/compare/engine.io-client@6.6.5...engine.io-client@6.6.6) (2026-06-16)

The `ws` dependency was bumped to `~8.21.0` following [CVE-2026-48779](https://github.com/advisories/GHSA-96hv-2xvq-fx4p).

### Bug Fixes

* preserve transport literal suggestions ([#5469](https://github.com/socketio/socket.io/issues/5469)) ([d8f392e](https://github.com/socketio/socket.io/commit/d8f392eec724f9f6d78a9523f8ef7a383a807a6d))


### Dependencies

- [`ws@~8.21.0`](https://github.com/websockets/ws/releases/tag/8.21.0) ([diff](https://github.com/websockets/ws/compare/8.20.1...8.21.0))
