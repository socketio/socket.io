...
| June 2026     | `engine.io`        | [Engine.IO WebTransport SID DoS](https://github.com/socketio/socket.io/security/advisories/GHSA-gr94-w7qr-f4j3)                    | `CVE-2026-59724` |
| June 2026     | `engine.io`        | [Engine.IO Polling Transport Connection Exhaustion](https://github.com/socketio/socket.io/security/advisories/GHSA-r635-g3xr-vw7x) | `CVE-2026-59725` |
